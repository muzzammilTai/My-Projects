...
const isFirstnameValid = /^[A-Za-z]+$/;

const isLastnameValid = /^[A-Za-z]+$/;
...
const checkFirstname = () => {
    ...
    } else if (!isFirstnameValid.test(firstname)) {
        showError(firstnameEl, "Invalid Firstname");
  ...
  const checkLastname = () => {
    ...
    } else if (!isLastnameValid.test(lastname)) {
        showError(lastnameEl, "Invalid Lastname");
