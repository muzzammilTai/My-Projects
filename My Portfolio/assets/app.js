!(function (t, e) {
  ...
  if (!r.TweenLite) {
    ...
    var P = t.requestAnimationFrame,
      ...
      k = O();
    for (n = ["ms", "moz", "webkit", "o"], s = n.length; --s > -1 && !P; )
      ...
      b.call(h),
        ...
        (h.fps = function (t) {
          return arguments.length
            ? ((i = t), (s = 1 / (i || 60)), (o = this.time + s), void h.wake())
            : i;
        }),
        (h.useRAF = function (t) {
    ...
    A(),
      ...
      (o.timeScale = function (t) {
        ...
        if (
          ((t = t || f), this._timeline && this._timeline.smoothChildTiming)
        ) {
    ...
    var M = v(
        ...
        function (e, i, r) {
          if (
            (C.call(this, i, r), (this.render = M.prototype.render), null == e)
          )
      ...
      N = function (t, e, i, r) {
        ...
        for (
          f.start = t,
            ...
            s = e.match(E) || [],
            r &&
              ((r._next = null), (r.blob = 1), (f._firstPT = f._applyPT = r)),
            l = s.length,
            a = 0;
          l > a;
          a++
      ...
      J = function (t, e, i) {
        ...
        return (
          ...
          s > e
            ...
            ? f
            : (s += t.totalDuration() / t._timeScale / n) > e + f
            ? 0
            : s - e - f
        );
      };
    (o._init = function () {
        ...
        D[e._gsTweenID] && Z(),
          this.vars.css ||
            (e.style &&
              ...
              L(this.vars, e));
        for (o in this.vars)
          if (((f = this.vars[o]), V[o]))
            f &&
              (f instanceof Array || (f.push && d(f))) &&
              -1 !== f.join("").indexOf("{self}") &&
              (this.vars[o] = f = this._swapSelfInParams(f, this));
          else if (
            I[o] &&
            (h = new I[o]())._onInitTween(e, this.vars[o], this, s)
          ) {
            for (
              this._firstPT = u =
                {
      ...
      (M.getTweensOf = function (t, e) {
        ...
        if ((d(t) || F(t)) && "number" != typeof t[0]) {
          ...
          for (r = H(t).concat(), i = r.length; --i > -1; )
    ...
    function (t, e, i) {
      ...
      return (
        ...
        (m.set = function (t, e, r) {
          return (
            ...
            null == e.immediateRender &&
              (e.immediateRender = r === this._time && !this._paused),
        ...
        (m.add = function (n, s, o, a) {
          var h, u, f, c, p, d;
          if (
            ("number" != typeof s && (s = this._parseTimeOrLabel(s, 0, !0, n)),
            !(n instanceof t))
          ) {
            if (n instanceof Array || (n && n.push && l(n))) {
              for (
                o = o || "normal", a = a || 0, h = s, u = n.length, f = 0;
                u > f;
                f++
              )
        ...
        (m.render = function (t, e, i) {
          ...
          if ((this._time !== d && this._first) || i || l || f) {
            if (
              ...
              for (
                r = this._first;
                r && ((o = r._next), c === this._time && (!this._paused || g));
              ...
              for (
                r = this._last;
                r && ((o = r._prev), c === this._time && (!this._paused || g));
          ...
          for (var s = [], o = this._first, a = 0; o; )
            o._startTime < n ||
              (o instanceof i
                ...
                : (r !== !1 && (s[a++] = o),
                  t !== !1 &&
                    ((s = s.concat(o.getChildren(!0, e, r))), (a = s.length)))),
              (o = o._next);
          return s;
        }),
        (m.getTweensOf = function (t, e) {
          var r,
            ...
            a = 0;
          for (
            s && this._enabled(!0, !0), r = i.getTweensOf(t), n = r.length;
            --n > -1;
      ...
      var u,
        ...
        tt = (q.calculateOffset = function (t, e, i) {
          ...
          var r = "left" === e ? "Left" : "Top",
            n = $(t, "margin" + r, i);
          return (
            t["offset" + r] - (J(t, e, parseFloat(n), n.replace(T, "")) || 0)
          );
        }),
        et = function (t, e) {
          var i,
              ...
              for (; --i > -1; )
                (n = e[i]),
                  (-1 === n.indexOf("-transform") || Ct === n) &&
                    (s[n.replace(C, R)] = e.getPropertyValue(n));
            else
              for (i in e)
      ...
      var _t = function (t, e, i, r) {
          ...
          return u
            ? (n = e
                ...
                : function (t) {
                    ...
                    if (((e = t.match(x) || []), (c = e.length), u > c--))
                      for (; ++c < u; ) e[c] = i ? e[((c - 1) / 2) | 0] : o[c];
                    return a + e.join(h) + l;
                  })
            : function (t) {
                return t;
        ...
        xt = (o.parseComplex = function (t, e, i, r, n, s, a, l, h, f) {
          ...
          for (
            ...
            if (((_ = A[c]), (x = R[c]), (b = parseFloat(_)), b || 0 === b))
              a.appendXtra(
                "",
                b,
                at(x, b),
              ...
              (k = x.indexOf(")") + 1),
                ...
                P && !U && 0 === x[3]
                  ? ((a["xs" + a.l] += a.l ? " transparent" : "transparent"),
                    (a.e = a.e.split(R[c]).join("transparent")))
                  : (U || (P = !1),
                    C
                      ? a
                          .appendXtra(
          ...
          if (-1 !== r.indexOf("=") && a.data) {
            for (k = a.xs0 + a.data.s, c = 1; c < a.l; c++)
        ...
        wt = 9;
      for (h = vt.prototype, h.l = h.pr = 0; --wt > 0; )
        (h["xn" + wt] = 0), (h["xs" + wt] = "");
      (h.xs0 = ""),
        (h._next =
          h._prev =
          ...
          if (!l[t]) {
            ...
            bt(t, {
              parser: function (t, i, r, n, s, o, h) {
                ...
                return u
                  ? (u._cssRegister(), l[r].parse(t, i, r, n, s, o, h))
      ...
      var St,
        ...
        Mt = (q.Transform = function () {
          (this.perspective = parseFloat(o.defaultTransformPerspective) || 0),
            (this.force3D =
              o.defaultForce3D !== !1 && Rt ? o.defaultForce3D || "auto" : !1);
        }),
        ...
        jt = function (t, e) {
          ...
          if (
            (kt
              ? (r = $(t, Ct, null, !0))
              : t.currentStyle &&
                ((r = t.currentStyle.filter.match(F)),
                (r =
                  r && 4 === r.length
                    ? [
                        r[0].substr(4),
            ...
            return Yt;
          for (n = (r || "").match(v) || [], wt = n.length; --wt > -1; )
            (s = Number(n[wt])),
              (n[wt] = (o = s - (s |= 0))
                ? ((o * h + (0 > o ? -0.5 : 0.5)) | 0) / h + s
                : s);
        ...
        It = (q.getTransform = function (t, i, r, n) {
          ...
          var s,
            ...
            _ = 1e5,
            m = Rt
              ? parseFloat($(t, At, i, !1, "0 0 0").split(" ")[2]) ||
                c.zOrigin ||
                0
              : 0,
            g = parseFloat(o.defaultTransformPerspective) || 0;
          if (
            ((c.svg = !(!t.getBBox || !Nt(t))),
            c.svg &&
              (Et(
                t,
                $(t, At, i, !1, "50% 50%") + "",
            ...
            if (16 === s.length) {
              ...
              c.zOrigin &&
                ...
                (c.z = E),
                c.svg &&
                  ((c.x -= c.xOrigin - (c.xOrigin * b - c.yOrigin * k)),
              ...
              (c.x = s[4] || 0),
                ...
                Rt &&
                  ...
                  (c.scaleZ = 1)),
                c.svg &&
                  ((c.x -= c.xOrigin - (c.xOrigin * I + c.yOrigin * q)),
              ...
              for (
                ...
                (S = nt[wt]),
                  ...
                  (i =
                    -1 !== P.indexOf("px")
                      ? parseFloat(P)
                      : J(this.t, S, parseFloat(P), P.replace(T, "")) || 0),
                  (O =
                    i !== r[S]
                      ? 2 > wt
                        ? -r.ieOffsetX
              ...
              if (
                ...
                return void (k || S.skewX || X
                  ? ((k *= E),
                    ...
                    b &&
                      "simple" === S.skewType &&
                      ((v = Math.tan(b - S.skewY * E)),
                      (v = Math.sqrt(1 + v * v)),
                      (i *= v),
                      (s *= v),
                      S.skewY &&
                        ((v = Math.tan(S.skewY * E)),
                        (v = Math.sqrt(1 + v * v)),
                        (e *= v),
                        (n *= v))),
                    X &&
                      ...
                      (z +=
                        S.yOrigin -
                        (S.xOrigin * n + S.yOrigin * s) +
                        S.yOffset),
                      St &&
                        (S.xPercent || S.yPercent) &&
                        ((_ = this.t.getBBox()),
                        (L += 0.01 * S.xPercent * _.width),
                        (z += 0.01 * S.yPercent * _.height)),
                      (_ = 1e-6),
                      _ > L && L > -_ && (L = 0),
                      _ > z && z > -_ && (z = 0)),
                    (x =
              ...
              (h = 1),
                ...
                (d || X) &&
                  ...
                  X &&
                    ...
                    (z +=
                      S.yOrigin - (S.xOrigin * n + S.yOrigin * s) + S.yOffset)),
                  _ > L && L > -_ && (L = T),
                  _ > z && z > -_ && (z = T),
                  _ > D && D > -_ && (D = 0)),
                (x =
            ...
            parser: function (t, e, i, r, s, a, l) {
              ...
              if (((r._transform = C), A && "string" == typeof A && kt))
                (f = I.style),
                  ...
                  null != S.xPercent &&
                    (u.xPercent = lt(S.xPercent, C.xPercent)),
                  null != S.yPercent &&
                    (u.yPercent = lt(S.yPercent, C.yPercent));
                ...
                "string" == typeof S.x &&
                  -1 !== S.x.indexOf("%") &&
                  ((u.x = 0), (u.xPercent = lt(S.x, C.xPercent))),
                  "string" == typeof S.y &&
                    -1 !== S.y.indexOf("%") &&
                    ((u.y = 0), (u.yPercent = lt(S.y, C.yPercent))),
                  (u.rotation = ht(
                    "rotation" in S
                      ? S.rotation
                      : "shortRotation" in S
              ...
              return (
                ...
                C.svg &&
                  ...
                  (_ !== C.xOffset || v !== C.yOffset) &&
                    ((s = yt(C, "xOffset", w ? _ : C.xOffset, C.xOffset, s, k)),
                ...
                p &&
                  (r._transformType =
                    (C.svg && St) || (!c && 3 !== this._transformType) ? 2 : 3),
                h && (l[i] = h),
                s
              );
            },
              ...
              this.p.indexOf("border") && (P[h] = H(P[h])),
                ...
                v !== y &&
                  ...
                  "%" === v
                    ? ((c = (w / m) * 100 + "%"), (f = (T / g) * 100 + "%"))
                    : "em" === v
                    ? ((b = J(t, "borderLeft", 1, "em")),
                      (c = w / b + "em"),
                      (f = T / b + "em"))
                    : ((c = w + "px"), (f = T + "px")),
                  x &&
                    ((p = parseFloat(c) + _ + v), (u = parseFloat(f) + _ + v))),
        ...
        bt("backgroundPosition", {
          ...
          parser: function (t, e, i, r, s, o) {
            ...
            if (
              ...
              g.split(",").length < 2 &&
              ((c = $(t, "backgroundImage").replace(A, "")), c && "none" !== c)
            ) {
              for (
                a = m.split(" "),
                  l = g.split(" "),
        ...
        100 === n &&
          ...
          e ||
            ...
            -1 === r.indexOf("pacity")
              ...
              : (i.filter = r.replace(b, "opacity=" + n)));
      };
      ...
      bt("className", {
        parser: function (t, e, r, s, o, a, l) {
          var h,
            ...
            _ = t.style.cssText;
          if (
            ((o = s._classNamePT = new vt(t, r, 0, 0, o, 2)),
            (o.setRatio = Ut),
            (o.pr = -11),
            (i = !0),
            (o.b = d),
                  ...
                  (v && O.test(p))
                    ? (v ||
                        ...
                        (p =
                          ...
                          p.join(",") +
                          ")")),
                      (i = xt(x, o, c, p, !0, "transparent", i, 0, s)))
                    : v && D.test(p)
...
(_gsScope._gsQueue || (_gsScope._gsQueue = [])).push(function () {
  ...
  var t = document.documentElement,
    ...
    i = function (i, r) {
      var n = "x" === r ? "Width" : "Height",
        ...
        a = document.body;
      return i === e || i === t || i === a
        ? Math.max(t[s], a[s]) - (e["inner" + n] || t[o] || a[o])
        : i[s] - i["offset" + n];
    },
    r = function (t) {
      return (
   ...
   */ !(function (t) {
    ...
    (t.fn.animate = function (r, s, l, h) {
      ...
      if (
        !o ||
        r.skipGSAP === !0 ||
        ("object" == typeof s && "function" == typeof s.step)
      )
        return n.call(this, r, s, l, h);
      var c,
        _,
  ...
  !(function (t, e) {
    ...
    t.Controller = function (r) {
      var s,
        ...
        w = function () {
          ...
          if (((p.container = n.get.elements(p.container)[0]), !p.container))
            throw a + " init failed.";
          (v =
            p.container === window ||
            ...
            (p.refreshInterval =
              parseInt(p.refreshInterval) || f.refreshInterval),
            T();
        },
        T = function () {
          p.refreshInterval > 0 &&
            (o = window.setTimeout(A, p.refreshInterval));
        },
        b = function () {
          return p.vertical
            ? n.get.scrollTop(p.container)
            : n.get.scrollLeft(p.container);
        },
        P = function () {
          return p.vertical
            ? n.get.height(p.container)
            : n.get.width(p.container);
        },
      ...
      return (
        ...
        (this.removeScene = function (t) {
          if (n.type.Array(t))
            ...
            var e = d.indexOf(t);
            e > -1 &&
              (t.off("shift.controller_sort"), d.splice(e, 1), t.remove());
          }
          return c;
        }),
    ...
    (t.Controller.addOption = function (t, e) {
      ...
      (t.Scene = function (i) {
        ...
        (this.on = function (t, e) {
            ...
            if (e) {
              ...
              o &&
                o.forEach(function (e) {
                  (s && s !== e.namespace) ||
                    e.callback.call(f, new t.Event(n, e.namespace, f, i));
                });
            }
            return f;
          }),
          ...
          (this.destroy = function (t) {
            return (
              f.trigger("destroy", { reset: t }), f.remove(), f.off("*.*"), null
            );
          }),
          (this.update = function (t) {
            if (o)
          ...
          (this.progress = function (t) {
            if (arguments.length) {
              ...
              if (
                ...
                u && i !== l && (_("enter"), _(i === a ? "start" : "end")),
                  _("progress"),
                  u && p !== l && (_(p === a ? "start" : "end"), _("leave"));
              }
              return f;
            }
            return d;
        ...
        var x = function () {
          ...
          P = n.extend(r.validate, {
            duration: function (t) {
              ...
              if (((t = parseFloat(t)), !n.type.Number(t) || 0 > t))
        ...
        var R = function (t) {
          ...
          L = function () {
            o &&
              ...
              p === l &&
              (((A.relSize.width || A.relSize.autoFullWidth) &&
                n.get.width(window) != n.get.width(A.spacer.parentNode)) ||
                (A.relSize.height &&
                  n.get.height(window) != n.get.height(A.spacer.parentNode))) &&
              M();
          },
          z = function (t) {
            o &&
        ...
        (this.setPin = function (t, i) {
          ...
          if (((i = n.extend({}, r, i)), (t = n.get.elements(t)[0]), !t))
            return f;
    ...
    (t.Scene.addOption = function (t, e, i, n) {
      t in r.defaults ||
        ((r.defaults[t] = e), (r.validate[t] = i), n && r.shifts.push(t));
    }),
      ...
      return (
        ...
        (c.offset = function (t, e) {
          ...
          if (t && t.getBoundingClientRect) {
            ...
            (i.top = r.top),
              (i.left = r.left),
              e || ((i.top += c.scrollTop()), (i.left += c.scrollLeft()));
          }
          return i;
        }),
    ...
    t.Scene.addOption("tweenChanges", !1, function (t) {
      ...
      t.Scene.extend(function () {
        ...
        (r.setTween = function (s, o, a) {
          var l;
          arguments.length > 1 &&
            (arguments.length < 3 && ((a = o), (o = 1)), (s = e.to(s, o, a)));
          try {
  ...
  $(document).ready(function () {
    ...
    if (
      ...
      var e = new ScrollMagic.Controller(),
        ...
        af = CSSRulePlugin.getRule(".about__wrapper:after"),
        a = new TimelineLite();
      a.from(r, 1.5, { x: 50, opacity: 0, ease: Power1.easeOut })
        .from(s, 1.5, { opacity: 0 }, "-=0.4")
        .from(o, 2, { cssRule: { opacity: 0 }, ease: Power1.easeOut }, af, 2, {
          cssRule: { opacity: 0 },
          ease: Power1.easeOut,
        });
      var l = new ScrollMagic.Scene({ triggerElement: i, reverse: !1 })
        .setTween(a)
        .addTo(e);
      var d1 = $(".d1"),
        c1 = $(".c1"),
        v1 = $(".visual-1"),
        f = new ScrollMagic.Scene({ triggerElement: d1, reverse: !1 })
          .setTween(
            TweenLite.from(v1, 0.8, {
              x: 100,
              opacity: 0,
              ease: Power1.easeOut,
            })
        ...
        c2 = $(".c2"),
        v2 = $(".visual-2"),
        d = new ScrollMagic.Scene({ triggerElement: d2, reverse: !1 })
          .setTween(
            TweenLite.from(v2, 0.8, {
              x: -100,
              opacity: 0,
              ease: Power1.easeOut,
            })
        ...
        c3 = $(".c3"),
        v3 = $(".visual-3"),
        f = new ScrollMagic.Scene({ triggerElement: d3, reverse: !1 })
          .setTween(
            TweenLite.from(v3, 0.8, {
              x: 100,
              opacity: 0,
              ease: Power1.easeOut,
            })
        ...
        c4 = $(".c4"),
        v4 = $(".visual-4"),
        d = new ScrollMagic.Scene({ triggerElement: d4, reverse: !1 })
          .setTween(
            TweenLite.from(v4, 0.8, {
              x: -100,
              opacity: 0,
              ease: Power1.easeOut,
            })
        ...
        c5 = $(".c5"),
        v5 = $(".visual-5"),
        f = new ScrollMagic.Scene({ triggerElement: d5, reverse: !1 })
          .setTween(
            TweenLite.from(v5, 0.8, {
              x: 100,
              opacity: 0,
              ease: Power1.easeOut,
            })
        ...
        c6 = $(".c6"),
        v6 = $(".visual-6"),
        d = new ScrollMagic.Scene({ triggerElement: d6, reverse: !1 })
          .setTween(
            TweenLite.from(v6, 0.8, {
              x: -100,
              opacity: 0,
              ease: Power1.easeOut,
            })
        ...
        c7 = $(".c7"),
        v7 = $(".visual-7"),
        f = new ScrollMagic.Scene({ triggerElement: d7, reverse: !1 })
          .setTween(
            TweenLite.from(v7, 0.8, {
              x: 100,
              opacity: 0,
              ease: Power1.easeOut,
            })
        ...
        w = $(".skill"),
        T = $(".skill__post"),
        b = $(".skill__view-more--el"),
        P = new TimelineLite();
      P.staggerFrom(T, 0.8, { opacity: 0, ease: Power1.easeOut }, 0.4).from(
        b,
        0.8,
        { opacity: 0, ease: Power1.easeOut },
        "-=0.2"
      );
      var S = new ScrollMagic.Scene({ triggerElement: w, reverse: !1 })
          .setTween(P)
          .addTo(e),
        O = $(".contact"),
        k = $(".contact__form"),
      ...
      var M = new ScrollMagic.Scene({ triggerElement: O, reverse: !1 })
        .setTween(R)
        .addTo(e);
    }
